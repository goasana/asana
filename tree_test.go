...
func TestAddTree(t *testing.T) {
	...
	if ctx.Param(":sd") != "123" || ctx.Param(":id") != "1" || ctx.Param(":page") != "12" {
	...
	if ctx.Param(":id") != "123" || ctx.Param(":shopid") != "zl" {
	...
	if ctx.Param(":sd") != "123" || ctx.Param(":id") != "1" || ctx.Param(":page") != "12" || ctx.Param(":shopid") != "zl" {
...
func TestAddTree2(t *testing.T) {
	...
	if ctx.Param(":id") != "123" || ctx.Param(":prefix") != "zl" || ctx.Param(":version") != "v1" {
...
func TestAddTree3(t *testing.T) {
	...
	if ctx.Param(":num") != "123" || ctx.Param(":sd") != "123" {
...
func TestAddTree4(t *testing.T) {
	...
	if ctx.Param(":info") != "12" || ctx.Param(":num") != "123" ||
		ctx.Param(":id") != "456" || ctx.Param(":sd") != "123" ||
		ctx.Param(":account") != "account" {
