...
// AsanaInput operates the http request header, data, cookie and body.
// it also contains router params and current session.
type AsanaInput struct {
	Context       *Context
...
// NewInput return AsanaInput generated by Context.
func NewInput() *AsanaInput {
	return &AsanaInput{
...
// Reset init the AsanaInput
func (input *AsanaInput) Reset(ctx *Context) {
	input.Context = ctx
...
func (input *AsanaInput) Domain() string {
	return input.Host()
}

// Host returns host name.
// if no host info in request, return localhost.
func (input *AsanaInput) Host() string {
...
func (input *AsanaInput) IP() string {
	ips := input.Proxy()
	if len(ips) > 0 && ips[0] != "" {
...
func (input *AsanaInput) Proxy() []string {
...
func (input *AsanaInput) Referer() string {
	return input.Header("Referer")
}

// Refer returns http referer header.
func (input *AsanaInput) Refer() string {
	return input.Referer()
}

// SubDomains returns sub domain string.
// if aa.bb.domain.com, returns aa.bb .
func (input *AsanaInput) SubDomains() string {
...
func (input *AsanaInput) Port() int {
...
func (input *AsanaInput) UserAgent() string {
	return input.Header("User-Agent")
}

// ParamsLen return the length of the params
func (input *AsanaInput) ParamsLen() int {
	return len(input.pnames)
}

// Param returns router param by a given key.
func (input *AsanaInput) Param(key string) string {
...
func (input *AsanaInput) Params() map[string]string {
...
func (input *AsanaInput) SetParam(key, val string) {
...
// passes.
func (input *AsanaInput) ResetParams() {
	input.pnames = input.pnames[:0]
	input.pvalues = input.pvalues[:0]
}

// Query returns input data item string by a given string.
func (input *AsanaInput) Query(key string) string {
...
func (input *AsanaInput) Header(key string) string {
	return input.Context.Request.Header.Get(key)
}

// Cookie returns request cookie item string by a given key.
// if non-existed, return empty string.
func (input *AsanaInput) Cookie(key string) string {
...
func (input *AsanaInput) Session(key interface{}) interface{} {
	return input.CruSession.Get(key)
}

// CopyBody returns the raw request body data as bytes.
func (input *AsanaInput) CopyBody(MaxMemory int64) []byte {
...
func (input *AsanaInput) Data() map[interface{}]interface{} {
	if input.data == nil {
...
func (input *AsanaInput) GetData(key interface{}) interface{} {
...
func (input *AsanaInput) SetData(key, val interface{}) {
	if input.data == nil {
		input.data = make(map[interface{}]interface{})
	}
	input.data[key] = val
...
func (input *AsanaInput) ParseFormOrMulitForm(maxMemory int64) error {
...
func (input *AsanaInput) Bind(dest interface{}, key string) error {
...
func (input *AsanaInput) bind(key string, typ reflect.Type) reflect.Value {
	if input.Context.Request.Form == nil {
		input.Context.Request.ParseForm()
	}
	rv := reflect.Zero(typ)
...
func (input *AsanaInput) bindValue(val string, typ reflect.Type) reflect.Value {
	rv := reflect.Zero(typ)
	switch typ.Kind() {
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		rv = input.bindInt(val, typ)
...
func (input *AsanaInput) bindInt(val string, typ reflect.Type) reflect.Value {
...
func (input *AsanaInput) bindUint(val string, typ reflect.Type) reflect.Value {
...
func (input *AsanaInput) bindFloat(val string, typ reflect.Type) reflect.Value {
...
func (input *AsanaInput) bindString(val string, typ reflect.Type) reflect.Value {
	return reflect.ValueOf(val)
}

func (input *AsanaInput) bindBool(val string, typ reflect.Type) reflect.Value {
...
func (input *AsanaInput) bindSlice(params *url.Values, key string, typ reflect.Type) reflect.Value {
	maxIndex := -1
	numNoIndex := 0
...
func (input *AsanaInput) bindStruct(params *url.Values, key string, typ reflect.Type) reflect.Value {
...
func (input *AsanaInput) bindPoint(key string, typ reflect.Type) reflect.Value {
	return input.bind(key, typ.Elem()).Addr()
}

func (input *AsanaInput) bindMap(params *url.Values, key string, typ reflect.Type) reflect.Value {
	var (
