...
import (
	...
	"github.com/goasana/asana/pkg/common"
)
...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/astaxie/asana/pkg/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/astaxie/asana/pkg/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/astaxie/asana/pkg/orm
	...
	go test -v github.com/astaxie/asana/pkg/orm
	...
	go test -v github.com/astaxie/asana/pgk/orm
