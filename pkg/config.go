...
func init() {
	...
	if !utils.FileExists(appConfigPath) {
		...
		if !utils.FileExists(appConfigPath) {
			AppConfig = &asanaAppConfig{innerConfig: config.NewFakeConfig()}
			return
		}
	}
...
func newAppConfig(appConfigProvider, appConfigPath string) (*asanaAppConfig, error) {
...
func (b *asanaAppConfig) Set(key, val string) error {
...
func (b *asanaAppConfig) String(key string) string {
...
func (b *asanaAppConfig) Strings(key string) []string {
...
func (b *asanaAppConfig) Int(key string) (int, error) {
...
func (b *asanaAppConfig) Int64(key string) (int64, error) {
...
func (b *asanaAppConfig) Bool(key string) (bool, error) {
...
func (b *asanaAppConfig) Float(key string) (float64, error) {
...
func (b *asanaAppConfig) DefaultString(key string, defaultVal string) string {
	if v := b.String(key); v != "" {
		return v
	}
	return defaultVal
...
func (b *asanaAppConfig) DefaultStrings(key string, defaultVal []string) []string {
...
func (b *asanaAppConfig) DefaultInt(key string, defaultVal int) int {
...
func (b *asanaAppConfig) DefaultInt64(key string, defaultVal int64) int64 {
...
func (b *asanaAppConfig) DefaultBool(key string, defaultVal bool) bool {
...
func (b *asanaAppConfig) DefaultFloat(key string, defaultVal float64) float64 {
...
func (b *asanaAppConfig) DIY(key string) (interface{}, error) {
	return b.innerConfig.DIY(key)
}

func (b *asanaAppConfig) GetSection(section string) (map[string]string, error) {
	return b.innerConfig.GetSection(section)
}

func (b *asanaAppConfig) SaveConfigFile(filename string) error {
