...
func (tc *TestController) Post() {
	tc.Ctx.Body([]byte(tc.Ctx.Query(":name")))
}
...
func (tc *TestController) List() {
	tc.Ctx.Body([]byte("i am list"))
}

func (tc *TestController) Params() {
	tc.Ctx.Body([]byte(tc.Ctx.Param("0") + tc.Ctx.Param("1") + tc.Ctx.Param("2")))
}

func (tc *TestController) Myext() {
	tc.Ctx.Body([]byte(tc.Ctx.Param(":ext")))
}

func (tc *TestController) GetURL() {
	tc.Ctx.Body([]byte(tc.URLFor(".Myext")))
}

func (tc *TestController) GetParams() {
	tc.Ctx.Text(tc.Ctx.Query(":last") + "+" +
		tc.Ctx.Query(":first") + "+" + tc.Ctx.Query("learn"))
}

func (tc *TestController) GetManyRouter() {
	tc.Ctx.Text(tc.Ctx.Query(":id") + tc.Ctx.Query(":page"))
}
...
func asanaBeforeRouter1(ctx *context.Context) {
	ctx.Text("|BeforeRouter1")
}

func asanaBeforeExec1(ctx *context.Context) {
	ctx.Text("|BeforeExec1")
}
...
func asanaFinishRouter1(ctx *context.Context) {
	ctx.Text("|FinishRouter1")
}

func asanaFinishRouter2(ctx *context.Context) {
	ctx.Text("|FinishRouter2")
}
