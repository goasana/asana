...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/goasana/asana/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/goasana/asana/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/goasana/asana/orm
	...
	go test -v github.com/goasana/asana/orm
